...
export HBASE_OPTS="$HBASE_OPTS -d64 -Xms8000m -XX:+UseParNewGC -XX:+UseConcMarkSweepGC -XX:+CMSIncrementalMode -XX:+CMSParallelRemarkEnabled -XX:+CMSInitiatingOccupancyFraction=70 -XX:+UseCMSInitiatingOccupancyOnly"
export HBASE_SSH_OPTS="$HBASE_SSH_OPTS -p 10022"
